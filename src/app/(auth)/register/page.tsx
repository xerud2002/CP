      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-slate-900">
        ...
        <div className="relative z-10 flex flex-col justify-center px-12 xl:px-20">
          <h1 className="text-4xl xl:text-5xl font-bold text-white mb-6 leading-tight">
            {isCurier ? (
              <>
                Găsește comenzi pe<br />
                <span className="text-gradient">rutele tale</span>
              </>
            ) : (
              <>
                Transporturi în<br />
          ...
          <p className="text-gray-400 text-lg mb-10 max-w-md">
            {isCurier 
              ...
              : 'Conectează-te cu curieri de încredere pentru transport complet: colete, plicuri, persoane, mobilă, electronice, animale, platformă și tractări auto în peste 20 țări europene.'}
          </p>
            ...
            {isCurier ? (
              <>
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-gray-300">Alegi țările și județele pe care le acoperi</span>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-green-500/20 border border-green-500/30 flex items-center justify-center">
                    <svg className="w-5 h-5 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-gray-300">Primești notificări pentru comenzi potrivite</span>
                </div>
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-green-500/20 border border-green-500/30 flex items-center justify-center">
                    <svg className="w-5 h-5 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span className="text-gray-300">Câștiguri pe rutele tale existente</span>
                </div>
              </>
            ) : (
              <>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-gray-300">Plată securizată și garantată</span>
                </div>
              </>
            )}
          </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-slate-950">
        <div className="w-full max-w-md">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">Parolă</label>
              <input
                type="password"
                value={password}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-2">Confirmă parola</label>
              <input
                type="password"
