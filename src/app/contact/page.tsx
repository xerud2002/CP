          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="card p-4 sm:p-6 bg-linear-to-br from-orange-500/10 to-purple-500/10 border-orange-500/20">
              ...
              <div className="flex gap-2 sm:gap-3">
                ...
                <a href="https://www.instagram.com/curierulperfect" target="_blank" rel="noopener noreferrer" className="p-2.5 sm:p-3 bg-white/5 hover:bg-white/10 rounded-lg transition min-w-11 min-h-11 flex items-center justify-center" aria-label="Instagram">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://www.tiktok.com/@curierulperfect" target="_blank" rel="noopener noreferrer" className="p-2.5 sm:p-3 bg-white/5 hover:bg-white/10 rounded-lg transition min-w-11 min-h-11 flex items-center justify-center" aria-label="TikTok">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
