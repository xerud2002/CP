            ...
            <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
              ...
              <div>
                ...
                <input
                  type="email"
                  required
                  className="form-input w-full text-sm sm:text-base min-h-[44px]"
              ...
              <button
                type="submit"
                disabled={loading}
                className="btn-primary w-full py-3 min-h-[48px] text-sm sm:text-base disabled:opacity-50"
              >
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="card p-4 sm:p-6 bg-linear-to-br from-orange-500/10 to-purple-500/10 border-orange-500/20">
              ...
              <div className="flex gap-2 sm:gap-3">
                <a href="https://www.facebook.com/profile.php?id=61571831621426" target="_blank" rel="noopener noreferrer" className="p-2.5 sm:p-3 bg-white/5 hover:bg-white/10 rounded-lg transition min-w-[44px] min-h-[44px] flex items-center justify-center" aria-label="Facebook">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                  </svg>
                </a>
                <a href="https://www.instagram.com/curierulperfect" target="_blank" rel="noopener noreferrer" className="p-2.5 sm:p-3 bg-white/5 hover:bg-white/10 rounded-lg transition min-w-[44px] min-h-[44px] flex items-center justify-center" aria-label="Instagram">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a href="https://www.tiktok.com/@curierulperfect" target="_blank" rel="noopener noreferrer" className="p-2.5 sm:p-3 bg-white/5 hover:bg-white/10 rounded-lg transition min-w-[44px] min-h-[44px] flex items-center justify-center" aria-label="TikTok">
                  <svg className="w-5 h-5 sm:w-6 sm:h-6 text-white" fill="currentColor" viewBox="0 0 24 24">
