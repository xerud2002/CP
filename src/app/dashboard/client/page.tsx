        ...
        {mainNavTiles.map((tile) => {
          ...
          return (
            <Link
              key={tile.href}
              href={tile.href}
              className={`group relative bg-gradient-to-br from-slate-800/90 via-slate-850/85 to-slate-900/90 backdrop-blur-xl rounded-xl border ${borderColor} p-3 sm:p-4 transition-all duration-300 hover:scale-[1.02] active:scale-95`}
            >
