...
const quickActions = [
  { label: 'Verifică comenzi noi', color: 'bg-orange-500 hover:bg-orange-600', href: '/dashboard/curier/comenzi', icon: 'box' },
  { label: 'Actualizează calendar', color: 'bg-emerald-500 hover:bg-emerald-600', href: '/dashboard/curier/calendar', icon: 'calendar' },
  { label: 'Modifică tarife', color: 'bg-purple-500 hover:bg-purple-600', href: '/dashboard/curier/tarife', icon: 'euro' },
  { label: 'Solicită retragere', color: 'bg-blue-500 hover:bg-blue-600', href: '/dashboard/curier/plati', icon: 'card' },
];
