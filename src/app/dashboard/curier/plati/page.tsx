          ...
          <div className="bg-linear-to-br from-slate-800 via-slate-800/95 to-slate-900 rounded-2xl sm:rounded-3xl p-5 sm:p-8 border border-white/10 relative overflow-hidden">
            ...
            <div className="relative">
              ...
              <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 mb-8">
                ...
                <button className="w-full lg:w-auto py-3.5 sm:py-4 px-8 sm:px-10 bg-linear-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white font-semibold rounded-xl transition-all shadow-xl shadow-emerald-500/30 hover:shadow-emerald-500/50 active:scale-[0.98] flex items-center justify-center gap-3 text-base sm:text-lg">
