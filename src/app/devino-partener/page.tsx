      ...
      <section className="relative py-20 px-4 bg-linear-to-b from-slate-800 via-slate-900 to-slate-900 overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-green-500/20 to-emerald-500/20 border border-green-500/30 text-green-400 text-sm font-semibold mb-8 animate-pulse">
            ...
            <span>Ofertă Limitată - 100% GRATUIT până pe 31 Martie 2026 - Fără Comisioane Ever!</span>
          </div>
          ...
          <p className="text-lg text-gray-400 mb-10">
            🚀 Zero comisioane (până 31 Martie 2026) • 📦 Comenzi nelimitate • ⚡ Contactezi clienții direct • ✅ Acces instant după verificare
          </p>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              { 
                ...
                title: 'Zero Comisioane (până 31 Martie 2026)', 
              ...
              { 
                ...
                desc: 'Comunicare în timp real cu clienții FĂRĂ intermediari. Contactezi direct clienții, răspunzi rapid la întrebări și clarifici detaliile comenzii. Acces gratuit până pe 31 Martie 2026.',
                color: 'purple'
              },
              { 
                icon: (
          ...
          <div className="space-y-4">
            {[
              { 
                ...
                a: 'Nu, platforma este 100% gratuită pentru curieri până pe 31 Martie 2026. Nu percepem comisioane din comenzi, nu există taxe de înregistrare sau abonamente. Păstrezi toți banii câștigați și contactezi clienții direct.',
                icon: (
              ...
              { 
                q: 'Cum primesc plata?', 
                a: 'Negociezi direct cu clientul metoda de plată prin chat-ul platformei (cash la ridicare/livrare, transfer bancar, etc.). Contactezi clienții direct, fără intermediari. Platforma nu procesează plăți, deci nu există întârzieri sau comisioane până pe 31 Martie 2026.',
                icon: (
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-20 px-4 bg-linear-to-b from-slate-800/50 to-slate-900">
        <div className="max-w-4xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full bg-green-500/20 border border-green-500/30 text-green-400 text-sm font-semibold mb-6">
            ...
            <span>Înregistrare 100% gratuită până pe 31 Martie 2026 - Fără comisioane vreodată</span>
          </div>
