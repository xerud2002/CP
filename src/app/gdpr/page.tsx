        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mb-12">
            ...
            <div className="card p-6 hover:border-red-500/30 transition group">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-red-500/20 to-pink-500/20 border border-red-500/30 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
          ...
          {/* Contact DPO */}
          <div className="card p-6 sm:p-8 bg-gradient-to-br from-orange-500/5 to-purple-500/5 border-orange-500/20">
