    ...
    <main className="min-h-screen bg-slate-900">
      <section className="py-20 px-4 bg-gradient-to-b from-slate-800 to-slate-900">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 px-4 py-2 rounded-lg">
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">Cum funcționează prețurile?</h2>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
            {servicii.map((serviciu) => (
              <div key={serviciu.id} className="card p-6 hover:border-orange-500/30 transition">
                <div className="text-4xl mb-3">{serviciu.icon}</div>
                <h3 className="text-lg font-bold text-white mb-2">{serviciu.name}</h3>
                <p className="text-sm text-gray-400 mb-4">{serviciu.desc}</p>
                <div className="space-y-1">
                  <p className="text-xs font-semibold text-orange-400 mb-2">Factori de preț:</p>
          ...
          <div className="card p-8 mb-12 bg-gradient-to-br from-orange-500/5 to-purple-500/5 border-orange-500/20">
            <h2 className="text-2xl font-bold text-white mb-6 text-center">Exemple de prețuri orientative</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center p-4 bg-slate-800/50 rounded-lg">
                <div className="text-3xl mb-2">📦</div>
                <h3 className="font-semibold text-white mb-1">Colet 5kg</h3>
                <p className="text-sm text-gray-400 mb-2">București → Cluj-Napoca</p>
                <p className="text-2xl font-bold text-orange-400">50-100 RON</p>
              </div>
              <div className="text-center p-4 bg-slate-800/50 rounded-lg">
                <div className="text-3xl mb-2">🛋️</div>
                <h3 className="font-semibold text-white mb-1">Mobilă 2 camere</h3>
                <p className="text-sm text-gray-400 mb-2">În aceeași oraș</p>
                <p className="text-2xl font-bold text-orange-400">300-600 RON</p>
              </div>
              <div className="text-center p-4 bg-slate-800/50 rounded-lg">
                <div className="text-3xl mb-2">🚗</div>
                <h3 className="font-semibold text-white mb-1">Auto pe platformă</h3>
                <p className="text-sm text-gray-400 mb-2">România → Germania</p>
                <p className="text-2xl font-bold text-orange-400">€300-500</p>
              </div>
            </div>
            ...
            <div className="card p-6">
              ...
              <ul className="space-y-2">
                {['Comisioane platformă', 'Taxe de plasare comandă', 'Costuri abonament', 'Taxe ascunse', 'Comisioane anulare', 'Taxe de modificare'].map((item, idx) => (
                  <li key={idx} className="flex items-center gap-2 text-gray-300 line-through opacity-60">
      ...
      <section className="py-16 px-4 bg-slate-800/50">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-white mb-6">Gata să economisești?</h2>
          <p className="text-gray-300 mb-8">
            Creează o comandă GRATUIT și primește oferte competitive de la curieri verificați
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/comanda" className="btn-primary px-8 py-3 text-lg">
              Plasează comandă acum
            </Link>
            <Link href="/cum-functioneaza" className="btn-secondary px-8 py-3 text-lg">
