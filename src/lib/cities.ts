...
export const oraseByCountryAndRegion: Record<string, Record<string, string[]>> = {
  ...
  // Scoția - orașe majore per regiune
  SC: {
    "Aberdeenshire": ["Aberdeen", "Peterhead", "Fraserburgh", "Inverurie", "Westhill", "Stonehaven", "Ellon"],
    "Angus": ["Forfar", "Arbroath", "Montrose", "Carnoustie", "Brechin", "Kirriemuir"],
    "Argyll and Bute": ["Helensburgh", "Dunoon", "Oban", "Campbeltown", "Rothesay"],
    "City of Edinburgh": ["Edinburgh", "Leith", "Portobello", "Corstorphine"],
    "Clackmannanshire": ["Alloa", "Clackmannan", "Tillicoultry", "Alva"],
    "Dumfries and Galloway": ["Dumfries", "Stranraer", "Annan", "Castle Douglas", "Kirkcudbright"],
    "Dundee City": ["Dundee", "Broughty Ferry"],
    "East Ayrshire": ["Kilmarnock", "Cumnock", "Stewarton", "Galston"],
    "East Dunbartonshire": ["Kirkintilloch", "Bearsden", "Milngavie", "Bishopbriggs"],
    "East Lothian": ["Haddington", "Musselburgh", "Tranent", "North Berwick", "Dunbar"],
    "East Renfrewshire": ["Giffnock", "Newton Mearns", "Barrhead", "Clarkston"],
    "Falkirk": ["Falkirk", "Grangemouth", "Bo'ness", "Denny", "Stenhousemuir"],
    "Fife": ["Dunfermline", "Kirkcaldy", "Glenrothes", "St Andrews", "Cowdenbeath", "Leven", "Methil", "Burntisland"],
    "Glasgow City": ["Glasgow", "Govan", "Pollokshields", "Partick", "Springburn"],
    "Highland": ["Inverness", "Fort William", "Thurso", "Wick", "Nairn", "Dingwall"],
    "Inverclyde": ["Greenock", "Port Glasgow", "Gourock"],
    "Midlothian": ["Dalkeith", "Penicuik", "Bonnyrigg", "Gorebridge"],
    "Moray": ["Elgin", "Forres", "Buckie", "Keith", "Lossiemouth"],
    "North Ayrshire": ["Irvine", "Kilwinning", "Ardrossan", "Saltcoats", "Largs"],
    "North Lanarkshire": ["Motherwell", "Coatbridge", "Airdrie", "Cumbernauld", "Bellshill", "Wishaw"],
    "Orkney Islands": ["Kirkwall", "Stromness"],
    "Perth and Kinross": ["Perth", "Crieff", "Blairgowrie", "Pitlochry", "Kinross"],
    "Renfrewshire": ["Paisley", "Renfrew", "Johnstone", "Erskine"],
    "Scottish Borders": ["Galashiels", "Hawick", "Peebles", "Kelso", "Selkirk", "Jedburgh"],
    "Shetland Islands": ["Lerwick", "Scalloway"],
    "South Ayrshire": ["Ayr", "Prestwick", "Troon", "Girvan", "Maybole"],
    "South Lanarkshire": ["East Kilbride", "Hamilton", "Rutherglen", "Cambuslang", "Lanark", "Blantyre"],
    "Stirling": ["Stirling", "Dunblane", "Bridge of Allan", "Callander"],
    "West Dunbartonshire": ["Clydebank", "Dumbarton", "Alexandria"],
    "West Lothian": ["Livingston", "Bathgate", "Linlithgow", "Whitburn", "Broxburn"],
    "Western Isles": ["Stornoway", "Tarbert", "Lochmaddy", "Lochboisdale"]
  },

  // Țara Galilor - orașe majore per regiune
  WLS: {
    "Anglesey": ["Holyhead", "Llangefni", "Amlwch", "Benllech"],
    "Blaenau Gwent": ["Ebbw Vale", "Tredegar", "Abertillery", "Brynmawr"],
    "Bridgend": ["Bridgend", "Porthcawl", "Maesteg", "Pencoed"],
    "Caerphilly": ["Caerphilly", "Bargoed", "Blackwood", "Risca", "Ystrad Mynach"],
    "Cardiff": ["Cardiff", "Llandaff", "Penarth", "Whitchurch", "Canton"],
    "Carmarthenshire": ["Carmarthen", "Llanelli", "Ammanford", "Llandeilo", "Burry Port"],
    "Ceredigion": ["Aberystwyth", "Cardigan", "Lampeter", "Aberaeron", "New Quay"],
    "Conwy": ["Conwy", "Llandudno", "Colwyn Bay", "Abergele", "Llanrwst"],
    "Denbighshire": ["Denbigh", "Rhyl", "Ruthin", "Prestatyn", "Llangollen"],
    "Flintshire": ["Mold", "Flint", "Buckley", "Connah's Quay", "Holywell", "Shotton"],
    "Gwynedd": ["Bangor", "Caernarfon", "Porthmadog", "Pwllheli", "Blaenau Ffestiniog"],
    "Merthyr Tydfil": ["Merthyr Tydfil", "Treharris"],
    "Monmouthshire": ["Abergavenny", "Monmouth", "Chepstow", "Caldicot", "Usk"],
    "Neath Port Talbot": ["Neath", "Port Talbot", "Pontardawe", "Briton Ferry"],
    "Newport": ["Newport", "Cwmbran", "Pontypool", "Caerleon"],
    "Pembrokeshire": ["Haverfordwest", "Pembroke", "Milford Haven", "Tenby", "Fishguard"],
    "Powys": ["Llandrindod Wells", "Newtown", "Ystradgynlais", "Brecon", "Welshpool", "Llanidloes"],
    "Rhondda Cynon Taf": ["Pontypridd", "Aberdare", "Mountain Ash", "Tonypandy", "Porth", "Treorchy"],
    "Swansea": ["Swansea", "Gorseinon", "Morriston", "Pontardulais", "Clydach"],
    "Torfaen": ["Pontypool", "Cwmbran", "Blaenavon"],
    "Vale of Glamorgan": ["Barry", "Penarth", "Cowbridge", "Llantwit Major", "Dinas Powys"],
    "Wrexham": ["Wrexham", "Rhosllanerchrugog", "Chirk", "Ruabon"]
  },

  // Irlanda de Nord - orașe majore per județ
  NIR: {
    "Antrim": ["Antrim", "Ballymena", "Ballyclare", "Carrickfergus", "Larne", "Lisburn", "Newtownabbey", "Crumlin"],
    "Armagh": ["Armagh", "Lurgan", "Portadown", "Craigavon", "Keady", "Tandragee"],
    "Down": ["Downpatrick", "Newry", "Bangor", "Newtownards", "Banbridge", "Holywood", "Newcastle", "Warrenpoint"],
    "Fermanagh": ["Enniskillen", "Lisnaskea", "Irvinestown", "Ballinamallard"],
    "Londonderry": ["Derry", "Coleraine", "Limavady", "Magherafelt", "Portstewart"],
    "Tyrone": ["Omagh", "Dungannon", "Strabane", "Cookstown", "Coalisland", "Fintona"]
  },

  // Moldova - orașe majore per raion
  MD: {
    "Anenii Noi": ["Anenii Noi", "Varnița"],
    "Bălți": ["Bălți"],
    "Basarabeasca": ["Basarabeasca"],
    "Bender": ["Bender"],
    "Briceni": ["Briceni", "Lipcani"],
    "Cahul": ["Cahul", "Giurgiulești"],
    "Călărași": ["Călărași"],
    "Cantemir": ["Cantemir"],
    "Căușeni": ["Căușeni", "Căinari"],
    "Chișinău": ["Chișinău", "Codru", "Vadul lui Vodă", "Durleşti", "Sîngera", "Cricova"],
    "Cimișlia": ["Cimișlia"],
    "Criuleni": ["Criuleni"],
    "Dondușeni": ["Dondușeni"],
    "Drochia": ["Drochia"],
    ...
    "Fălești": ["Fălești", "Sculeni"],
    "Florești": ["Florești", "Ghindești"],
    "Glodeni": ["Glodeni"],
    "Hîncești": ["Hîncești", "Leușeni"],
    "Ialoveni": ["Ialoveni", "Costești"],
    "Leova": ["Leova", "Iargara"],
    "Nisporeni": ["Nisporeni"],
    "Ocnița": ["Ocnița", "Otaci"],
    "Orhei": ["Orhei", "Trebujeni"],
    "Rezina": ["Rezina"],
    "Rîșcani": ["Rîșcani", "Costești"],
    "Sîngerei": ["Sîngerei"],
    "Soroca": ["Soroca", "Cosăuți"],
    "Strășeni": ["Strășeni", "Bucovăț"],
